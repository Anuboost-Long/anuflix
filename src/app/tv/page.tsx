      ...
      <div className={clsx("px-[clamp(1.25rem,4vw,4.5rem)]")}>
        ...
        <div className={clsx("mt-8")}>
          ...
          <p className="mt-4 max-w-xl text-base leading-7 text-text-secondary">
            Long-form stories, current favorites, and acclaimed series worth the time.
          </p>
        </div>
      </div>
      <MediaRow title="Popular series" items={popular} priority />
      <MediaRow title="On the air" items={airing} />
      <MediaRow title="Airing today" items={today} />
