          ...
          <section aria-labelledby="episodes-title">
            <div className="mb-6 flex items-end justify-between gap-4">
              <div>
                ...
                <h2
                  id="episodes-title"
                  className="mt-1 text-2xl font-bold tracking-tight text-text-primary"
                >
                  {season?.name ?? "Choose a season"}
                </h2>
              </div>
              <SeasonSelector
                mediaId={media.id}
              ...
              <div className="divide-y divide-border border-y border-border">
                {season.episodes.map((episode) => {
                  ...
                  return (
                    <Link
                      key={episode.id}
                      href={`/watch/tv/${media.id}/${episode.season_number}/${episode.episode_number}`}
                    ...
                    >
                      ...
                      <span className="flex size-10 items-center justify-center rounded-full border border-border-strong text-brand-light group-hover:bg-brand-primary group-hover:text-white">
